...
public:
    ...
    public:
        ...
        Repeat *repeat;
        AspectRatio *aRatio;
        QAction *togglePlay, *stop, *next, *prev, *rec, *prevFrame, *nextFrame, *abRepeat, *seekF, *seekB, *lSeekB, *lSeekF, *speedUp, *slowDown, *setSpeed, *switchARatio, *integerScaling, *zoomIn, *zoomOut, *setZoom, *reset, *continuePlayback, *volUp, *volDown, *toggleMute, *detach;
