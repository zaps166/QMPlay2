...
public:
	...
	public:
		...
		Repeat *repeat;
		AspectRatio *aRatio;
		QAction *togglePlay, *stop, *next, *prev, *nextFrame, *abRepeat, *seekF, *seekB, *lSeekB, *lSeekF, *speedUp, *slowDown, *setSpeed, *switchARatio, *zoomIn, *zoomOut, *reset, *volUp, *volDown, *toggleMute, *suspend;
	};
