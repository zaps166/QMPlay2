...
public:
    ...
    public:
        ...
        QMenu *extensions;
        Sort *sort;
        QAction *stopLoading, *sync, *quickSync, *loadPlist, *savePlist, *saveGroup, *lock, *alwaysSync, *delEntries, *delNonGroupEntries, *clear, *copy, *paste, *pasteAndPlay, *newGroup, *renameGroup, *find, *collapseAll, *expandAll, *goToPlayback, *queue, *skip, *stopAfter, *entryProperties;
    };
    ...
    public:
        ...
        Repeat *repeat;
        AspectRatio *aRatio;
        QAction *togglePlay, *stop, *next, *prev, *prevFrame, *nextFrame, *abRepeat, *seekF, *seekB, *lSeekB, *lSeekF, *speedUp, *slowDown, *setSpeed, *switchARatio, *zoomIn, *zoomOut, *reset, *continuePlayback, *volUp, *volDown, *toggleMute, *detach;
