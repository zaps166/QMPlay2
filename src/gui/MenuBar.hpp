...
public:
	...
	public:
		...
		QMenu *extensions;
		Sort *sort;
		QAction *stopLoading, *sync, *quickSync, *loadPlist, *savePlist, *delPlist, *saveGroup, *lock, *alwaysSync, *delEntries, *delNonGroupEntries, *clear, *copy, *paste, *newGroup, *renameGroup, *find, *collapseAll, *expandAll, *goToPlayback, *queue, *skip, *stopAfter, *entryProperties;
	};
