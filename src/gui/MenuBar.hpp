...
public:
	...
	public:
		...
		QMenu *extensions;
		Sort *sort;
		QAction *stopLoading, *sync, *loadPlist, *savePlist, *delEntries, *delNonGroupEntries, *clear, *copy, *paste, *newGroup, *renameGroup, *find, *collapseAll, *expandAll, *goToPlaying, *queue, *entryProperties;
	};
